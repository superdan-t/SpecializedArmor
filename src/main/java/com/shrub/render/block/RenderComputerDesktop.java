...
import com.shrub.model.ModelComputerDesktop;
...
public class RenderComputerDesktop extends TileEntitySpecialRenderer {
	
	public static final ResourceLocation texture = new ResourceLocation(Main.modID + ":textures/model/ComputerBasic.png");
	
	private ModelComputerDesktop model;
	
	public RenderComputerDesktop() {
		this.model = new ModelComputerDesktop();
	}

...
import cc.sdspar.spar.inventory.gui.GuiAlloyMixer;
...
public class GuiHandler implements IGuiHandler {
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		case Ref.GUI_ALLOY_MIXER:
			return new ContainerAlloyMixer(player.inventory, (TileEntityAlloyMixer)world.getTileEntity(new BlockPos(x, y, z)));
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		case Ref.GUI_ALLOY_MIXER:
			return new GuiAlloyMixer(player.inventory, (TileEntityAlloyMixer)world.getTileEntity(new BlockPos(x, y, z)));
		case Ref.GUI_ALLOY_FURNACE:
